...
///
/// Harness code may grant this dataset to all tasks and seed deterministic Parquet fixture data in
/// MinIO to keep integration tests stable.
...
/// Version-addressed storage prefix (S3 URI) for the alerts fixture dataset Parquet artifacts.
