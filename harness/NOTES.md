...
- `TRACE_CRYO_MODE=real` shells out to `cryo` using the CLI shape: `cryo <dataset> --rpc <url> --blocks <start:end> --output-dir <dir>` (source of truth: `harness/src/cryo_worker.rs`).
