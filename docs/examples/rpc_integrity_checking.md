...
Operator: [`rpc_integrity_check`](../specs/operators/rpc_integrity_check.md)
...
Configure this as a reactive DAG job using `operator: rpc_integrity_check`. See [Example DAG Config](../specs/operators/rpc_integrity_check.md#example-dag-config) for an example job entry, and [dag_configuration.md](../specs/dag_configuration.md) for the full job YAML schema.
