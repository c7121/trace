...
| [alert_evaluate_py](alert_evaluate_py.md) | lambda, ecs_platform | reactive | PerUpdate | Evaluate alerts (Python) |
| [alert_evaluate_rs](alert_evaluate_rs.md) | lambda, ecs_platform | reactive | PerUpdate | Evaluate alerts (Rust) |
