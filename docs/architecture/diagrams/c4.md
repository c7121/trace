...
| Operator | Activation | Execution |
|----------|------------|----------|
| `block_follower` | `source` | — |
| `cryo_ingest` | `reactive` | PerPartition |
| `parquet_compact` | `reactive` | Bulk |
| `alert_evaluate_*` | `reactive` | PerUpdate |
| `alert_deliver` | `reactive` | PerUpdate |
| `query` | `reactive` | Bulk |
